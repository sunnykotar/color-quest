      ...
      <div className="hud-strip">
        <div style={{ flex:1, display:"flex", flexDirection:"column", gap:3 }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:6 }}>
            <span style={{ fontFamily:"var(--font-display)", fontSize:13, fontWeight:700, color:"#1e1b4b" }}>
            ...
            {hardMode && (
              <span style={{ fontSize:10, background:"rgba(239,68,68,0.15)", color:"#dc2626", padding:"2px 7px", borderRadius:99 }}>
                🔥 Hard Mode
              </span>
            )}
          </div>
